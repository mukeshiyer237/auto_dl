...
def fashion_mnist_func():
    st.title("Fashion_MNIST")
    st.write("The dataset contains grayscale images of clothes and accessories. This dataset is used for training a multiclass classification model that can classify or recognize clothes and accessories.")
    ...
    if st.button("Train Model"):
        ...
        model.add(Conv2D(filters=32, kernel_size=(3,3), activation=act, padding=pad))
        model.add(BatchNormalization(axis=chanDim))
